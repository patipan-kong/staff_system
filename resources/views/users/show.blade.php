...
<div class="row">
    <div class="col-12 d-flex justify-content-between align-items-center mb-4">
        <h1><i class="fas fa-user"></i> Team Member Profile</h1>
...
<div class="row">
    <div class="col-md-4">
        <div class="card">
            <div class="card-body text-center">
                @if($user->photo ?? false)
                    <img src="{{ asset(Storage::url($user->photo)) }}" alt="Profile" class="rounded-circle mb-3" width="120" height="120">
                @else
                ...
                <h4>{{ $user->name }}</h4>
                @if($user->nickname)
                    <p class="text-muted mb-1">"{{ $user->nickname }}"</p>
                @endif
        ...
        <div class="card mt-3">
            ...
            <div class="card-body">
                ...
                @if($user->vacation_quota !== null)
                    <div class="mb-2">
                        <strong>Annual Vacation Days:</strong><br>
                        <i class="fas fa-calendar-alt text-muted me-2"></i>
                        {{ $user->vacation_quota }} days per year
                    </div>
                @endif
                <div class="mb-2">
    ...
    <div class="col-md-8">
        ...
        <!-- Recent Activity -->
        @if($user->timesheets && $user->timesheets->count() > 0)
        <div class="card mb-4">
            <div class="card-header">
            ...
            <div class="card-body p-0">
                <div class="table-responsive">
                    <table class="table table-hover mb-0">
                        ...
                        <tbody>
                            @foreach($user->timesheets->take(5) as $timesheet)
                            <tr>
...
<!-- Leave Summary for Current Year -->
        ...
        <!-- Leave Requests -->
        @if($user->leaves && $user->leaves->count() > 0)
        <div class="card">
            <div class="card-header">
